...
public class WaterOsmSource extends GeoJSONTileSource {
	...
	private static final String PATH = "/vectiles-water-areas/";
	 ...
	 */
	protected WaterOsmSource(String hostName, int port) {
