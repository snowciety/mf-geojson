...
public class BuildingsOsmSource extends GeoJSONTileSource {
	...
	private static final String PATH = "/vectiles-buildings/";
	 ...
	 */
	protected BuildingsOsmSource(String hostName, int port) {
